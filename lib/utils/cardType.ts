...
// "In Your Collection" tiles to color-code each version's border at a
// glance. Parallel takes priority over Insert/Base since it's a modifier
// that can apply to either — a parallel of a Base card is still visually
// "a Parallel", not "a Base". See lib/utils/cardClassification.ts for the
// underlying rules.
